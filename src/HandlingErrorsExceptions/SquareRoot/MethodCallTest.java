...
public class MethodCallTest {
    ...
    // откуда вызван метод, вызвавший данный утилитарный метод.
    // Или null (нулевую ссылку, а не строку "null"),
    // если метод, вызвавший getCallerClassAndMethodName()
    // является точкой входа в программу, т.е. его никто не вызывал.

    // Это актуально, например, в библиотеках логирования, где для
    // каждого сообщения в логе надо выводить класс и метод,
...
//    org.stepic.java.example.Test#main
    ...
    // Вы можете получить другой результат: вместо null в первой строчке
    // будет напечатан какой-то посторонний класс и метод.
    // Это связно с тем, что среда разработки обычно запускает не Ваш класс,
    // а свой собственный, который затем уже вызывает Ваш.
